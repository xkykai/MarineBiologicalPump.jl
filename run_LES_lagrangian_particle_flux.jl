...
const w_sinking = -Lz / (8 * 24 * 60^2)
# const w_sinking = 0

const stop_time = 4days
...
FILE_NAME = "Lagrangian_n_particles_$(n_particles)_QU_$(Qᵁ)_QB_$(Qᴮ)_dbdz_$(dbdz)_Lxz_$(Lx)_$(Lz)_Nxz_$(Nx)_$(Nz)_w_$(w_sinking)"
